...
float3 LUX_BumpedLightmap(float3 f3TextureNormal, float4 f4LightmapTexCoord1And2, float4 f4LightmapTexCoord3, int iDetailBlendMode = 0, float3 f3DetailTexture = float3(0.5f, 0.5f, 0.5f))
{
	...
	float3 f3DiffuseLighting = dp.x * f3LightmapColor1 + dp.y * f3LightmapColor2 + dp.z * f3LightmapColor3;
...
//===========================================================================//
float3 LUX_SSBumpedLightmap(float3 f3SSBump, float4 f4LightmapTexCoord1And2, float4 f4LightmapTexCoord3)
{
	float2 f2BumpCoord1;
	float2 f2BumpCoord2;
	float2 f2BumpCoord3;

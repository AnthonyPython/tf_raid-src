...
// I have no idea what the compiler might spit out for this, aka how optimised it might be, but it probably doesn't matter.
//===========================================================================//
...
{\
	params[Vec3Var]->SetVecValue( x, y);\
}
...
// Also sets Default Blending Shadow State when there is no flashlight.

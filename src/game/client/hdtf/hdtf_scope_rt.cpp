...
ITexture* CTNERenderTargets::CreateViewModelTexture(IMaterialSystem* pMaterialSystem)
{
	return pMaterialSystem->CreateNamedRenderTargetTextureEx2(
		"_rt_Viewmodel",
		1024, 1024, RT_SIZE_FULL_FRAME_BUFFER,
...
void CTNERenderTargets::InitClientRenderTargets(IMaterialSystem* pMaterialSystem, IMaterialSystemHardwareConfig* pHardwareConfig)
{
	...
	m_VMTexture.Init(CreateViewModelTexture(pMaterialSystem));

...
class CWeaponStunStick : public CBaseMeleeWeapon
{
public:
	DECLARE_CLASS( CWeaponStunStick, CBaseMeleeWeapon );
...
#define	NUM_BEAM_ATTACHMENTS 9
	...
	void DrawFirstPersonEffects( );
	void DrawThirdPersonEffects( );
	void DrawEffects( );
	bool InSwing( );
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CWeaponStunStick::GetStunState( )
{
	return m_bActive;
}
...
//-----------------------------------------------------------------------------
void C_WeaponStunStick::SetupAttachmentPoints( )
{
...
//-----------------------------------------------------------------------------
void C_WeaponStunStick::ClientThink( )
{
	if( !InSwing( ) )
	{
...
//-----------------------------------------------------------------------------
RenderGroup_t C_WeaponStunStick::GetRenderGroup( )
{
...
//-----------------------------------------------------------------------------
void C_WeaponStunStick::DrawThirdPersonEffects( )
{
	Vector vecOrigin;
	QAngle vecAngles;
	float color[3];
...
// Purpose: Draw our special effects
//-----------------------------------------------------------------------------
void C_WeaponStunStick::DrawFirstPersonEffects( )
{
	Vector vecOrigin;
	QAngle vecAngles;
	float color[3];
...
// Purpose: Draw our special effects
//-----------------------------------------------------------------------------
void C_WeaponStunStick::DrawEffects( )
{
	if( ShouldDrawUsingViewModel( ) )

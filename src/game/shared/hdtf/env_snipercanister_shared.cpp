...
BEGIN_SIMPLE_DATADESC(CEnvSniperCanisterShared)
...
BEGIN_NETWORK_TABLE_NOBASE(CEnvSniperCanisterShared, DT_EnvSniperCanisterShared)
...
// Constructor
//-----------------------------------------------------------------------------
CEnvSniperCanisterShared::CEnvSniperCanisterShared()
{
...
//-----------------------------------------------------------------------------
// Creates a canister in the world
//-----------------------------------------------------------------------------
void CEnvSniperCanisterShared::InitInWorld(float flLaunchTime,
...
//-----------------------------------------------------------------------------
// Creates a canister in the skybox
//-----------------------------------------------------------------------------
void CEnvSniperCanisterShared::InitInSkybox(float flLaunchTime,
...
//-----------------------------------------------------------------------------
void CEnvSniperCanisterShared::ConvertFromSkyboxToWorld()
{
	Assert(m_bInSkybox);
	m_bInSkybox = false;
}
...
//-----------------------------------------------------------------------------
float CEnvSniperCanisterShared::GetEnterWorldTime() const
{
...
// Did we impact?
//-----------------------------------------------------------------------------
bool CEnvSniperCanisterShared::DidImpact(float flTime) const
{
...
//-----------------------------------------------------------------------------
void CEnvSniperCanisterShared::GetPositionAtTime(float flTime, Vector &vecPosition, QAngle &vecAngles)
{
...
//-----------------------------------------------------------------------------
bool CEnvSniperCanisterShared::IsInSkybox()
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void CEnvSniperCanisterShared::CalcEnterTime(const Vector &vecTriggerMins,

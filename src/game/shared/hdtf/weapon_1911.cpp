...
#define CWeapon1911 C_Weapon1911

#endif

class CWeapon1911 : public CBaseHDTFCombatWeapon
{
public:
	DECLARE_CLASS( CWeapon1911, CBaseHDTFCombatWeapon );
...
private:
	CWeapon1911( const CWeapon1911 & );
};

IMPLEMENT_NETWORKCLASS_ALIASED( Weapon1911, DT_Weapon1911 )

BEGIN_NETWORK_TABLE( CWeapon1911, DT_Weapon1911 )
...
BEGIN_PREDICTION_DATA( CWeapon1911 )
...
// Purpose:
//-----------------------------------------------------------------------------
void CWeapon1911::PrimaryAttack( )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeapon1911::UpdatePenaltyTime( )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeapon1911::ItemBusyFrame( )
{
	UpdatePenaltyTime( );
...
//-----------------------------------------------------------------------------
void CWeapon1911::ItemPostFrame( )
{
...
void CWeapon1911::EnableIronsights()
{
...
void CWeapon1911::DisableIronsights(bool ignoreAnimation)
{

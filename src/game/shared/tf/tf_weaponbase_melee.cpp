...
bool CTFWeaponBaseMelee::DoSwingTraceInternal( trace_t &trace, bool bCleave, CUtlVector< trace_t >* pTargetTraceVector )
{
	...
	bool bDontHitTeammates = (pPlayer->GetTeamNumber() == TF_TEAM_PVE_INVADERS && TFGameRules()->IsMannVsMachineMode() || pPlayer->GetTeamNumber() == TF_TEAM_PVE_DEFENDERS && TFGameRules()->IsRaidMode());
